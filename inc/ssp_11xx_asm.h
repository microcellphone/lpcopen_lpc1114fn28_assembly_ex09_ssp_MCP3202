...
#ifndef __SSP_11XX_ASM_H_
#define __SSP_11XX_ASM_H_
...
#define SSP_OFFSET_CR0	0x000		/*!< Control Register 0. Selects the serial clock rate, bus type, and data size. */
#define SSP_OFFSET_CR1	0x004		/*!< Control Register 1. Selects master/slave and other modes. */
#define SSP_OFFSET_DR	0x008		/*!< Data Register. Writes fill the transmit FIFO, and reads empty the receive FIFO. */
#define SSP_OFFSET_SR	0x00c		/*!< Status Register        */
#define SSP_OFFSET_CPSR	0x010		/*!< Clock Prescale Register */
#define SSP_OFFSET_IMSC	0x014		/*!< Interrupt Mask Set and Clear Register */
#define SSP_OFFSET_RIS	0x018		/*!< Raw Interrupt Status Register */
#define SSP_OFFSET_MIS	0x01c		/*!< Masked Interrupt Status Register */
#define SSP_OFFSET_ICR	0x020		/*!< SSPICR Interrupt Clear Register */
...
#define SSP_CR1_LBM_EN      (1 << 0)
/** SSP control 1 enable bit */
#define SSP_CR1_SSP_EN      (1 << 1)
/** SSP control 1 slave enable */
#define SSP_CR1_SLAVE_EN    (1 << 2)
#define SSP_CR1_MASTER_EN    (0)
/** SSP control 1 slave out disable bit, disables transmit line in slave
   mode */
#define SSP_CR1_SO_DISABLE  (1 << 3)
/** SSP CR1 bit mask */
#define SSP_CR1_BITMASK     (0x0F)

/** SSP CPSR bit mask */
#define SSP_CPSR_BITMASK    (0xFF)
/**
 ...
 */
#define SSP_STAT_TFE  ((1 << 0))/**< TX FIFO Empty */
#define SSP_STAT_TNF  ((1 << 1))/**< TX FIFO not full */
#define SSP_STAT_RNE  ((1 << 2))/**< RX FIFO not empty */
#define SSP_STAT_RFF  ((1 << 3))/**< RX FIFO full */
#define SSP_STAT_BSY  ((1 << 4))/**< SSP Busy */

/**
 * @brief SSP Type of Interrupt Mask
 */
#define SSP_RORIM  ((1 << 0))	/**< Overun */
#define SSP_RTIM  ((1 << 1))/**< TimeOut */
#define SSP_RXIM  ((1 << 2))/**< Rx FIFO is at least half full */
#define SSP_TXIM  ((1 << 3))/**< Tx FIFO is at least half empty */
#define SSP_INT_MASK_BITMASK  ((0xF))

/**
 * @brief SSP Type of Mask Interrupt Status
 */
#define SSP_RORMIS  ((1 << 0))	/**< Overun */
#define SSP_RTMIS  ((1 << 1))	/**< TimeOut */
#define SSP_RXMIS  ((1 << 2))	/**< Rx FIFO is at least half full */
#define SSP_TXMIS  ((1 << 3))	/**< Tx FIFO is at least half empty */
#define SSP_MASK_INT_STAT_BITMASK  ((0xF))

/**
 * @brief SSP Type of Raw Interrupt Status
 */
#define SSP_RORRIS   ((1 << 0))	/**< Overun */
#define SSP_RTRIS   ((1 << 1)) 	/**< TimeOut */
#define SSP_RXRIS   ((1 << 2)) 	/**< Rx FIFO is at least half full */
#define SSP_TXRIS   ((1 << 3)) 	/**< Tx FIFO is at least half empty */
#define SSP_RAW_INT_STAT_BITMASK   ((0xF))

#define SSP_RORIC   0x0
#define SSP_RTIC   0x1
#define SSP_INT_CLEAR_BITMASK   0x3

/*
 * @brief SSP clock format
 */
#define SSP_CLOCK_CPHA0_CPOL0   (0 << 6) 		/**< CPHA = 0  CPOL = 0 */
#define SSP_CLOCK_CPHA0_CPOL1   (1u << 6) 		/**< CPHA = 0  CPOL = 1 */
#define SSP_CLOCK_CPHA1_CPOL0   (2u << 6) 		/**< CPHA = 1  CPOL = 0 */
#define SSP_CLOCK_CPHA1_CPOL1   (3u << 6) 		/**< CPHA = 1  CPOL = 1 */
#define SSP_CLOCK_MODE0   SSP_CLOCK_CPHA0_CPOL0 /**< alias */
#define SSP_CLOCK_MODE1   SSP_CLOCK_CPHA1_CPOL0 /**< alias */
#define SSP_CLOCK_MODE2   SSP_CLOCK_CPHA0_CPOL1 /**< alias */
#define SSP_CLOCK_MODE3   SSP_CLOCK_CPHA1_CPOL1 /**< alias */

/*
 * @brief SSP frame format
 */
#define SSP_FRAMEFORMAT_SPI  (0 << 4)			/**< Frame format: SPI */
#define CHIP_SSP_FRAME_FORMAT_TI  (1u << 4)			/**< Frame format: TI SSI */
#define SSP_FRAMEFORMAT_MICROWIRE  (2u << 4)	/**< Frame format: Microwire */

/*
 * @brief Number of bits per frame
 */
#define SSP_BITS_4   (3u << 0) 		/*!< 4 bits/frame */
#define SSP_BITS_5   (4u << 0) 		/*!< 5 bits/frame */
#define SSP_BITS_6   (5u << 0) 		/*!< 6 bits/frame */
#define SSP_BITS_7   (6u << 0) 		/*!< 7 bits/frame */
#define SSP_BITS_8   (7u << 0) 		/*!< 8 bits/frame */
#define SSP_BITS_9   (8u << 0) 		/*!< 9 bits/frame */
#define SSP_BITS_10   (9u << 0) 	/*!< 10 bits/frame */
#define SSP_BITS_11   (10u << 0) 	/*!< 11 bits/frame */
#define SSP_BITS_12   (11u << 0) 	/*!< 12 bits/frame */
#define SSP_BITS_13   (12u << 0) 	/*!< 13 bits/frame */
#define SSP_BITS_14   (13u << 0) 	/*!< 14 bits/frame */
#define SSP_BITS_15   (14u << 0) 	/*!< 15 bits/frame */
#define SSP_BITS_16   (15u << 0) 	/*!< 16 bits/frame */
 ...
 * @brief SSP mode
 */
#define SSP_MODE_MASTER = (0 << 2)	/**< Master mode */
#define SSP_MODE_SLAVE = (1u << 2)	/**< Slave mode */
